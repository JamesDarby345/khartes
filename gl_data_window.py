    ...
    def drawFragments(self):
        ...
        for fv in fvs:
            ...
            if fv == pv.nearby_node_fv:
                ...
                selected_nodes = fv.selected_nodes
                if len(nz) > 0:
                    ind = nz[0]
            ...
            # Prepare to update colors on fvao
            color = dw.nodeColor
...
class FragmentVao:
    ...
    def updateNodeColors(self, default_color, inactive_color, highlight_color, selected_color, manual_color, nearby_node_id, selected_nodes):
        ...
        # Convert colors to float32 arrays (0-1 range)
    ...
    def getVao(self):
        ...
        f.glVertexAttribPointer(
            self.color_location,  # location=6 as specified in shader
            4,  # 4 components (RGBA)
            int(pygl.GL_FLOAT),
            int(pygl.GL_FALSE),
            0,
